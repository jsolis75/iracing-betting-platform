# Setup Multiplayer Database

To enable the Multiplayer Fantasy Mode, you need to create the necessary tables in your Supabase database.
...
Once this script is run, the Multiplayer features will be fully functional.
