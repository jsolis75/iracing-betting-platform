...
# Configuration
# AUTO-DETECT: If running locally, use localhost. If distributed, use production.
# For the downloadable script, we default to production.
API_URL = "https://iracing-betting-platform.vercel.app/api/telemetry/ingest"
API_KEY = "iracing-broadcast-key-123"
...
def broadcast_data():
    ...
    while True:
        ...
        # Once connected
        print("\n✅ Connected to iRacing! Broadcasting data...")
